...
export T2ExpFit, T2NoiseExpFit, T2EpgNoiseFit, qmri_echoAmplitudes
...
"""
    T2ExpFit(ima::Array{T,4},t::Union{Vector{<:Real},StepRange{<:Real,<:Real}},p0=nothing) where T<:Real
...
"""
function T2ExpFit(ima::Array{T,4},t::Union{Vector{<:Real},StepRange{<:Real,<:Real}},p0=nothing;removePoint::Bool=true) where T<:Real
...
"""
    T2NoiseExpFit(ima::Array{T,4},t::Union{Vector{<:Real},StepRange{<:Real,<:Real}},p0=nothing; kwargs...) where T<:Real
...
"""
function T2NoiseExpFit(ima::Array{T,4},t::Union{Vector{<:Real},StepRange{<:Real,<:Real}},p0=nothing;removePoint::Bool=true,L::Int=1) where T<:Real
    @assert size(ima,4) == length(t)
...
"""
T2EpgNoiseFit(ima::Array{T,4},params::Dict{Symbol,Any},x0::Vector{Float64}) where T<:Real
...
"""
function T2EpgNoiseFit(ima::Array{T,4},params::Dict{Symbol,Any},x0::Vector{Float64}=[1,70.0,0.9,0]) where T<:Real
